...
export default class SwitchNode {
    constructor(expression, cases, defaultBody = null) {
        ...
        if (defaultBody !== null && !Array.isArray(defaultBody)) {
            throw new ViewError("SwitchNode requires an array or null for defaultBody.");
        }

        this.type = "SwitchNode";
        this.expression = expression.trim();
        this.cases = cases;             // array of CaseNode instances
        this.defaultBody = defaultBody; // array of AST nodes or null
    }
}
