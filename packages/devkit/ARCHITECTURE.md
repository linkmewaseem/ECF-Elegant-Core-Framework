# Architecture Decision Record (ADR) — `@ecf/devkit`
...
5. **AI-Ready Abstraction**: `AIStubGenerator` establishes the prompt and template abstraction layer for Milestone 30 `@ecf/ai`.
